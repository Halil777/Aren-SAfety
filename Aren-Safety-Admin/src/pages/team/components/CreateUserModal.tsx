        ...
        onError: (error: any) => {
          message.error(
            error.response?.data?.message ||
              t("team.createUserModal.createError")
          );
        },
      });
    } catch (error) {
      ...
      >
        ...
        >
          ...
          >
            ...
            <Badge
              count={t("team.createUserModal.required")}
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: t("team.createUserModal.usernameRequired"),
                  },
                  { min: 3, message: t("team.createUserModal.usernameMin") },
                  {
                    pattern: /^[a-zA-Z0-9_]+$/,
                    message: t("team.createUserModal.usernamePattern"),
                  },
                ]}
              >
                <Input
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: t("team.createUserModal.passwordRequired"),
                  },
        ...
        >
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: t("team.createUserModal.firstNameRequired"),
                  },
                ]}
              >
                <Input
                  size="large"
                  placeholder={t("team.createUserModal.firstNamePlaceholder")}
                />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: t("team.createUserModal.lastNameRequired"),
                  },
                ]}
              >
                <Input
                  size="large"
                  placeholder={t("team.createUserModal.lastNamePlaceholder")}
                />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: t("team.createUserModal.emailRequired"),
                  },
                  {
                    type: "email",
                    message: t("team.createUserModal.emailInvalid"),
                  },
                ]}
              >
                <Input
            ...
            <Col span={12}>
              <Form.Item name="phone" label={t("team.createUserModal.phone")}>
                <Input
                  size="large"
        ...
        >
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: t("team.createUserModal.positionRequired"),
              },
            ]}
                    ...
                    <>
                      ...
                      <Space style={{ padding: "0 8px 4px" }}>
                        <Button
                          ...
                          style={{ width: "100%" }}
                        >
                          {t("team.createUserModal.useCustom", {
                ...
                isLoadingRoles ? (
                  <div style={{ padding: "16px", textAlign: "center" }}>
                    ...
                    <div style={{ marginTop: 8, color: "#8c8c8c" }}>
                      {t("team.createUserModal.loadingRoles")}
                    </div>
                  </div>
                ) : (
                  <div style={{ padding: "16px", textAlign: "center" }}>
          ...
          >
            <Space size={4} align="start">
              ...
              <div
                style={{
                  fontSize: "12px",
                  color: isDarkMode ? "#91d5ff" : "#096dd9",
                }}
              >
                <strong>{t("team.createUserModal.tipTitle")}</strong>{" "}
                {t("team.createUserModal.tipDescription")}
              </div>
            </Space>
          </div>
        </div>
