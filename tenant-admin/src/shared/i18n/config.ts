  ...
  en: {
    translation: {
      ...
      dashboard: {
        ...
        observationsDashboardDescription: "Overview of all observations with filters and analytics",
        filterByDateAndRisk: "Filter observations by date range and risk level",
        startDate: "Start Date",
        endDate: "End Date",
        riskLevel: "Risk Level",
        allLevels: "All Levels",
        level1Low: "Level 1 - Low",
        level2: "Level 2",
        level3Medium: "Level 3 - Medium",
        level4: "Level 4",
        level5High: "Level 5 - High",
        ...
        observationsByLocation: "Observations by Location",
        numberOfObservationsAtEachLocation: "Number of observations at each location",
        top5Supervisors: "Top 5 Supervisors",
        supervisorsWithMostObservations: "Supervisors with most observations created",
  ...
  tr: {
    translation: {
      ...
      dashboard: {
        ...
        observationsDashboardDescription: "Filtreler ve analizlerle tüm gözlemlere genel bakış",
        filterByDateAndRisk: "Gözlemleri tarih aralığı ve risk seviyesine göre filtreleyin",
        startDate: "Başlangıç Tarihi",
        endDate: "Bitiş Tarihi",
        riskLevel: "Risk Seviyesi",
        allLevels: "Tüm Seviyeler",
        level1Low: "Seviye 1 - Düşük",
        level2: "Seviye 2",
        level3Medium: "Seviye 3 - Orta",
        level4: "Seviye 4",
        level5High: "Seviye 5 - Yüksek",
        resetFilters: "Filtreleri Sıfırla",
        showingObservations: "{{total}} gözlemden {{filtered}} tanesi gösteriliyor",
        ...
        observationsByLocation: "Lokasyonlara Göre Gözlemler",
        numberOfObservationsAtEachLocation: "Her lokasyondaki gözlem sayısı",
  ...
  ru: {
    translation: {
      ...
      dashboard: {
        ...
        observationsDashboardDescription: "Обзор всех наблюдений с фильтрами и аналитикой",
        filterByDateAndRisk: "Фильтруйте наблюдения по диапазону дат и уровню риска",
        startDate: "Начальная Дата",
        endDate: "Конечная Дата",
        riskLevel: "Уровень Риска",
        allLevels: "Все Уровни",
        level1Low: "Уровень 1 - Низкий",
        level2: "Уровень 2",
        level3Medium: "Уровень 3 - Средний",
        level4: "Уровень 4",
        level5High: "Уровень 5 - Высокий",
        ...
        numberOfObservationsAtEachLocation: "Количество наблюдений в каждой локации",
        top5Supervisors: "Топ 5 Руководителей",
        supervisorsWithMostObservations: "Руководители с наибольшим числом наблюдений",
